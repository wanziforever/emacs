...
(defun my-sublime ()
  ...
  (color-theme-install
   '(my-sublime
     ...
     (font-lock-builtin-face ((t (:foreground "#92c6f0"))))
     (font-lock-comment-face ((t (:foreground "#736443" ))))
     (font-lock-constant-face ((t (:foreground "#a881ff"))))
     (font-lock-doc-string-face ((t (:foreground "#9b859d"))))
     (font-lock-function-name-face ((t (:foreground "#88da2c" :bold t))))
     (font-lock-keyword-face ((t (:foreground "#e15579" :bold t))))
     (font-lock-preprocessor-face ((t (:foreground "#aeaeae"))))
     (font-lock-reference-face ((t (:foreground "green"))))
     (font-lock-string-face ((t (:foreground "#edcf88"))))
     (font-lock-type-face ((t (:foreground "#fff" :bold t))))
