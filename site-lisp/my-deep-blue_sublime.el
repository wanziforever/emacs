...
;;      (background-mode . dark)
    ...
    (viper-saved-cursor-color-in-replace-mode . "Red3"))
     ...
     (font-lock-doc-string-face ((t (:foreground "#A8F13E"))))
...
(add-to-list 'color-themes '(my-deep-blue_sublime  "THEME NAME" "YOUR NAME"))

(provide 'my-deep-blue_sublime)
