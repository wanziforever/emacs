...
;;      (background-mode . dark)
    ...
    (viper-saved-cursor-color-in-replace-mode . "Red3"))
     ...
     (font-lock-other-type-face ((t (:foreground "yellow"))))
     ...
     (py-class-name-face ((t (:foreground "#FFFFB6"))))
     ...
     (py-XXX-tag-face ((t (:foreground "#3CB371" :slant italic))))
...
(add-to-list 'color-themes '(my-deep-blue_atom "THEME NAME" "YOUR NAME"))

(provide 'my-deep-blue_atom)
