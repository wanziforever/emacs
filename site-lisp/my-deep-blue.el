...
;;      (background-mode . dark)
    ...
    (viper-saved-cursor-color-in-replace-mode . "Red3"))
     ...
     ;;(calendar-today-face ((t (:background "blue" :underline t))))
     ;;(change-log-acknowledgement-face ((t (:italic t :foreground "CadetBlue" :slant italic))))
     ;;(change-log-conditionals-face ((t (:background "sienna" :foreground "SeaGreen2"))))
     ;;(change-log-date-face ((t (:foreground "burlywood"))))
     ;;(change-log-email-face ((t (:foreground "SeaGreen2" :underline t))))
     ;;(change-log-file-face ((t (:bold t :foreground "goldenrod" :weight bold))))
     ;;(change-log-function-face ((t (:background "sienna" :foreground "SeaGreen2"))))
     ...
     ;;(completions-common-part ((t (:family "Anonymous" :foundry "unknown" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeee" :background "#102e4e" :stipple nil :height 105))))
     ...
     ;;(custom-button ((t (:bold t :background "lightgrey" :foreground "black" :box (:line-width 2 :style released-button) :weight bold))))
     ;;(custom-button-mouse ((t (:background "grey90" :foreground "black" :box (:line-width 2 :style released-button)))))
     ;;(custom-button-pressed ((t (:background "lightgrey" :foreground "gray30" :box (:line-width 2 :style pressed-button)))))
     ...
     ;;(custom-comment ((t (:background "dim gray" :foreground "white"))))
     ;;(custom-comment-tag ((t (:foreground "white"))))
     ;;(custom-documentation ((t (:foreground "light blue"))))
     ;;(custom-face-tag ((t (:bold t :weight bold :foreground "#f0e68c" :underline t))))
     ;;(custom-group-tag ((t (:bold t :family "helv" :foreground "light blue" :underline t :weight bold :height 1.2))))
     ;;(custom-group-tag-1 ((t (:bold t :family "helv" :foreground "pink" :underline t :weight bold :height 1.2))))
     ...
     ;;(custom-variable-tag ((t (:bold t :foreground "light blue" :underline t :weight bold))))
     ...
     ;;(cvs-msg-face ((t (:italic t :foreground "gray85" :slant italic))))
     ;;(cvs-need-action-face ((t (:foreground "orange"))))
     ;;(cvs-unknown-face ((t (:foreground "red"))))
     ;;(cyan ((t (:foreground "cyan"))))
     ;;(diary-face ((t (:bold t :foreground "orange red" :weight bold))))
     ...
     ;;(diff-header-face ((t (:background "grey45" :foreground "lemon chiffon"))))
     ...
     ;;(dired-perm-write ((t (:italic t :foreground "CadetBlue" :slant italic))))
     ...
     ;;(fixed-pitch ((t (:foundry "outline" :family "fixed"))))
     ...
     (font-lock-comment-delimiter-face ((t (:bold t :italic t :slant italic :foreground "#87ceeb"))))
     (font-lock-comment-face ((t (:bold t :italic t :foreground "#87ceeb" :slant italic))))
     (font-lock-constant-face ((t (:foreground "#fff"))))
     (font-lock-doc-string-face ((t (:foreground "#ffa0a0"))))
     (font-lock-function-name-face ((t (:bold t :foreground "#fff" :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "#f0e68c" :weight bold))))
     (font-lock-other-emphasized-face ((t (:bold t :foreground "#fff" :weight bold))))
     (font-lock-other-type-face ((t (:bold t :foreground "#98fb98" :weight bold))))
     ...
     ;;(font-lock-doc-face ((t (:bold t :foreground "BlanchedAlmond" :weight bold))))
