...
;;  C-x h w `highlight-regexp-current-word'
;;  C-x h r `highlight-regexp-regexp'
;;  C-x h s `highlight-regexp-string'
;;  C-x h c `highlight-regexp-clear'
;;  C-x h d `highlight-regexp-delete'
...
(when highlight-regexp-use-bindings-p
  (global-set-key "\C-xhw" 'highlight-regexp-current-word)
  (global-set-key "\C-xhr" 'highlight-regexp-regexp)
  (global-set-key "\C-xhs" 'highlight-regexp-string)
  (global-set-key "\C-xhc" 'highlight-regexp-clear)
  (global-set-key "\C-xhd" 'highlight-regexp-delete)
  )
