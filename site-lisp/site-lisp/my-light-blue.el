...
(defun my-light-blue ()
  ...
  (color-theme-install
   '(my-light-blue
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "#606"))))
     (font-lock-keyword-face ((t (:foreground "#2F4F4F" ))))
     (font-lock-other-emphasized-face ((t (:foreground "black" :weight bold))))
     (font-lock-other-type-face ((t (t :foreground "#606" ))))
     (font-lock-preprocessor-face ((t (:foreground "#800"))))
     ;;(font-lock-string-face ((t (:foreground "#080"))))
     (font-lock-string-face ((t (:foreground "#800" :background "#9A9A9A"))))
     (font-lock-type-face ((t (:foreground "#008"))))
