...
;;      (background-mode . dark)
    ...
    (viper-saved-cursor-color-in-replace-mode . "Red3"))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "#FFD2A7" :weight bold))))
     ...
     (py-class-name-face ((t (:foreground "#FFFFB6" :underline t :weight bold))))
     (py-pseudo-keyword-face ((t (:foreground "#C6C5F0"))))
     (py-decorators-face ((t (:foreground "#CFCB90"))))
     (py-builtins-face ((t (:foreground "#CFCB90"))))
